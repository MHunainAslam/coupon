                ...
                <div class="modal-content">
                    {data.Style === 1 ?
                        <>
                            ...
                            <div class="modal-body">
                                ...
                                <div className='text-center mt-3'>
                                    ...
                                    <Link href={`${popup?.url}`} className={`button button-secondary my-4  px-1  ${popup?.code ? '' : 'mt-1'}`} onClick={() => navigator.clipboard.writeText(`${popup?.code}`)}>{popup?.code ? `Copy and Go To the ${store}` : `Go To the ${store}`}</Link>
                                </div>
                            </div>
                            <div class="p-3">
                        ...
                        <>
                           ...
                           <div class="modal-body back-light position-relative ">
                                <Image className='mx-auto my-4 col-5 modal-logo position-relative ' src={img + "/" + data.logo.header} fill={true}></Image>
                                <br /> <Link className='h5 text-secondary' href="#">{popup?.title}</Link>
                                <p className='tr-2 my-1' dangerouslySetInnerHTML={{ __html: popup?.description }}></p>
                                <div className='text-center mt-3'>
                                    <small className={`p-2   ${popup?.code ? 'bg-code  h3' : ''}`}>{popup?.code || 'No Coupon Needed'}</small> <br />
                                    <Link href={`${popup?.url}`} className='button button-secondary my-4 px-1 mt-0' onClick={() => navigator.clipboard.writeText(`${popup?.code}`)}>{popup?.code ? `Copy and Go To the ${store}` : `Go To the ${store}`}</Link>
                                </div>
                            </div>
                           </div>
                            <div class="p-3">
